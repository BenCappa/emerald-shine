...
// Shiny odds
#define SHINY_ODDS 32 // Actual probability is SHINY_ODDS/65536 -> 1/2048 = 0.048828125% chance
...
enum EvolutionConditions {
    ...
    IF_MONEY_COUNT,                     // The Player has the specific amount of money. It then deducts that amount.
