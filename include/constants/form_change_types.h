...
// FORM_CHANGE_TIME_OF_YEAR param1 Arguments
enum FormChangeSeasonArguments
{
    SPRING = 1,
    SUMMER,
    AUTUMN,
...
enum FormChanges
{
    ...
    // Form change that activates at a certain time of year in the overworld automatically.
    // param1: time of year to check.
    // - SPRING if Form change that activates in Jan, May, Sep.
    // - SUMMER if Form change that activates in Feb, Jun, Oct.
    // - AUTUMN if Form change that activates in Mar, Jul, Nov.
    // - WINTER if Form change that activates in Apr, Aug, Dec.
    FORM_CHANGE_TIME_OF_YEAR,
