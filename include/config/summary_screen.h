...
#define P_FLAG_EGG_MOVES                 FLAG_EGG_MOVES_RELEARNER     // If this flag is set, enables egg move relearner.
#define P_FLAG_TUTOR_MOVES               FLAG_TUTOR_MOVES_RELEARNER   // If this flag is set, enables tutor move relearner.
