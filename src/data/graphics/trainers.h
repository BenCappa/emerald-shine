...
const u32 gTrainerFrontPic_LeaderOriana[] = INCBIN_U32("graphics/trainers/front_pics/leader_roxanne.4bpp.smol");
const u16 gTrainerPalette_LeaderOriana[] = INCBIN_U16("graphics/trainers/front_pics/leader_roxanne.gbapal");

const u32 gTrainerFrontPic_LeaderNiles[] = INCBIN_U32("graphics/trainers/front_pics/leader_brawly.4bpp.smol");
const u16 gTrainerPalette_LeaderNiles[] = INCBIN_U16("graphics/trainers/front_pics/leader_brawly.gbapal");
...
const u32 gTrainerFrontPic_LeaderIliyah[] = INCBIN_U32("graphics/trainers/front_pics/leader_flannery.4bpp.smol");
const u16 gTrainerPalette_LeaderIliyah[] = INCBIN_U16("graphics/trainers/front_pics/leader_flannery.gbapal");

const u32 gTrainerFrontPic_LeaderMicheal[] = INCBIN_U32("graphics/trainers/front_pics/leader_norman.4bpp.smol");
const u16 gTrainerPalette_LeaderMicheal[] = INCBIN_U16("graphics/trainers/front_pics/leader_norman.gbapal");
...
const u32 gTrainerFrontPic_LeaderRheannon[] = INCBIN_U32("graphics/trainers/front_pics/leader_juan.4bpp.smol");
const u16 gTrainerPalette_LeaderRheannon[] = INCBIN_U16("graphics/trainers/front_pics/leader_juan.gbapal");
...
const struct TrainerSprite gTrainerSprites[] =
{
    ...
    TRAINER_SPRITE(TRAINER_PIC_LEADER_ORIANA, gTrainerFrontPic_LeaderOriana, gTrainerPalette_LeaderOriana),
    TRAINER_SPRITE(TRAINER_PIC_LEADER_NILES, gTrainerFrontPic_LeaderNiles, gTrainerPalette_LeaderNiles),
    TRAINER_SPRITE(TRAINER_PIC_LEADER_WATTSON, gTrainerFrontPic_LeaderWattson, gTrainerPalette_LeaderWattson),
    TRAINER_SPRITE(TRAINER_PIC_LEADER_ILIYAH, gTrainerFrontPic_LeaderIliyah, gTrainerPalette_LeaderIliyah),
    TRAINER_SPRITE(TRAINER_PIC_LEADER_MICHEAL, gTrainerFrontPic_LeaderMicheal, gTrainerPalette_LeaderMicheal),
    ...
    TRAINER_SPRITE(TRAINER_PIC_LEADER_RHEANNON, gTrainerFrontPic_LeaderRheannon, gTrainerPalette_LeaderRheannon),
