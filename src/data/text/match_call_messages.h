...
const u8 gText_MatchCallBeauty_Thalia_Strategy[] = _("More than meets the eye!");
const u8 gText_MatchCallBeauty_Thalia_Pokemon[] = _("Gorgeous and loyal.");
const u8 gText_MatchCallBeauty_Thalia_Intro1[] = _("I dream of one day escaping");
const u8 gText_MatchCallBeauty_Thalia_Intro2[] = _("the hardships of my beauty.");
...
const u8 gText_MatchCallYoungster_Joey_Strategy[] = _("I do what I can.");
const u8 gText_MatchCallYoungster_Joey_Pokemon[] = _("I use different types.");
const u8 gText_MatchCallYoungster_Joey_Intro1[] = _("I'm going to keep working");
const u8 gText_MatchCallYoungster_Joey_Intro2[] = _("until I beat a Gym Leader.");
...
const u8 gText_MatchCallRockinWhiz_Oriana_Strategy[] = _("Small but fierce attack.");
const u8 gText_MatchCallRockinWhiz_Oriana_Pokemon[] = _("I prefer cute baby Pokémon.");
const u8 gText_MatchCallRockinWhiz_Oriana_Intro1[] = _("A Leader of a big Gym bears");
const u8 gText_MatchCallRockinWhiz_Oriana_Intro2[] = _("a lot of responsibility.");

const u8 gText_MatchCallTheBigHit_Niles_Strategy[] = _("Discover our dormant power!");
const u8 gText_MatchCallTheBigHit_Niles_Pokemon[] = _("My Pokémon are rock-hard!");
const u8 gText_MatchCallTheBigHit_Niles_Intro1[] = _("People keep quoting me");
const u8 gText_MatchCallTheBigHit_Niles_Intro2[] = _("without any conext!");
...
const u8 gText_MatchCallPassionBurn_Iliyah_Strategy[] = _("Battle aggressively.");
const u8 gText_MatchCallPassionBurn_Iliyah_Pokemon[] = _("Burn with passion!");
const u8 gText_MatchCallPassionBurn_Iliyah_Intro1[] = _("I give it my all but not");
const u8 gText_MatchCallPassionBurn_Iliyah_Intro2[] = _("because you told me to!");

const u8 gText_MatchCallReliableOne_Dad_Strategy[] = _("Direct physical action!");
const u8 gText_MatchCallReliableOne_Dad_Pokemon[] = _("Fighting Pokémon rule!");
const u8 gText_MatchCallReliableOne_Dad_Intro1[] = _("Headstrong! I'll take you");
const u8 gText_MatchCallReliableOne_Dad_Intro2[] = _("on! I'll take on anyone!");
...
const u8 gText_MatchCallDandyCharm_Rheannon_Strategy[] = _("I use splendid waterpower.");
const u8 gText_MatchCallDandyCharm_Rheannon_Pokemon[] = _("Pokémon of elegance!");
const u8 gText_MatchCallDandyCharm_Rheannon_Intro1[] = _("The adulation of beautiful");
const u8 gText_MatchCallDandyCharm_Rheannon_Intro2[] = _("ladies fills me with energy!");
...
const u8 gText_MatchCallEliteFour_Juan_Strategy[] = _("Confuse and confound.");
const u8 gText_MatchCallEliteFour_Juan_Pokemon[] = _("There's nothing definite.");
const u8 gText_MatchCallEliteFour_Juan_Intro1[] = _("Age is just a number.");
const u8 gText_MatchCallEliteFour_Juan_Intro2[] = _("I'm in my prime!");
...
const u8 *const gMatchCallFlavorTexts[REMATCH_TABLE_ENTRIES][CHECK_PAGE_ENTRY_COUNT] =
{
    ...
    [REMATCH_ORIANA] = MCFLAVOR(RockinWhiz_Oriana),
    [REMATCH_NILES] = MCFLAVOR(TheBigHit_Niles),
    [REMATCH_WATTSON] = MCFLAVOR(SwellShock_Wattson),
    [REMATCH_ILIYAH] = MCFLAVOR(PassionBurn_Iliyah),
    [REMATCH_MICHEAL] = MCFLAVOR(ReliableOne_Dad),
    [REMATCH_WINONA] = MCFLAVOR(SkyTamer_Winona),
    [REMATCH_TATE_AND_LIZA] = MCFLAVOR(MysticDuo_TateAndLiza),
    [REMATCH_RHEANNON] = MCFLAVOR(DandyCharm_Rheannon),
    [REMATCH_SIDNEY] = MCFLAVOR(EliteFour_Sidney),
    [REMATCH_JUAN] = MCFLAVOR(EliteFour_Juan),
