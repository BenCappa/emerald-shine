const u16 gFacilityClassToPicIndex[] =
{
    ...
    [FACILITY_CLASS_LEADER_ORIANA] = TRAINER_PIC_LEADER_ORIANA,
    [FACILITY_CLASS_LEADER_NILES] = TRAINER_PIC_LEADER_NILES,
...
const enum TrainerClassID gFacilityClassToTrainerClass[] =
{
    ...
    [FACILITY_CLASS_LEADER_ORIANA] = TRAINER_CLASS_LEADER,
    [FACILITY_CLASS_LEADER_NILES] = TRAINER_CLASS_LEADER,
