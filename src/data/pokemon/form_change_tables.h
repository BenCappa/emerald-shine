...
static const struct FormChange sSawsbuckFormChangeTable[] = {
    {FORM_CHANGE_TIME_OF_YEAR, SPECIES_SAWSBUCK_SPRING, SPRING},
    {FORM_CHANGE_TIME_OF_YEAR, SPECIES_SAWSBUCK_SUMMER, SUMMER},
    {FORM_CHANGE_TIME_OF_YEAR, SPECIES_SAWSBUCK_AUTUMN, AUTUMN},
    {FORM_CHANGE_TIME_OF_YEAR, SPECIES_SAWSBUCK_WINTER, WINTER},
    {FORM_CHANGE_TERMINATOR},
};
