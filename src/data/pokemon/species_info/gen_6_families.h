...
const struct SpeciesInfo gSpeciesInfoGen6[] =
{
    ...
    [SPECIES_DELPHOX_MEGA] =
    {
        ...
        .weight = 390,
        .description = COMPOUND_STRING(
            "The flames it once used for divination\n"
            "became unbounded and unpredictable.\n"
            "Only through Mega Evolution can it hope\n"
            "to control the fire's unwieldy power."),
        .pokemonScale = 268,
        .pokemonOffset = 2,
        .trainerScale = 271,
        .trainerOffset = 0,
...
#define AEGISLASH_MAIN_STAT (P_UPDATED_STATS >= GEN_8 ? 140 : 150)
    ...
    [SPECIES_GOOMY] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 40, SPECIES_SLIGGOO},
                                {EVO_LEVEL, 40, SPECIES_SLIGGOO_HISUI, CONDITIONS({IF_HOLD_ITEM, ITEM_METAL_ALLOY})}),
    },
    ...
    [SPECIES_BERGMITE] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 37, SPECIES_AVALUGG},
                                {EVO_LEVEL, 37, SPECIES_AVALUGG_HISUI, CONDITIONS({IF_HOLD_ITEM, ITEM_STRANGE_SOUVENIR})}),
    },
