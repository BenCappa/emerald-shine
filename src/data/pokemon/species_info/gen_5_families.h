...
const struct SpeciesInfo gSpeciesInfoGen5[] =
{
    ...
    [SPECIES_DEWOTT] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 36, SPECIES_SAMUROTT},
                                {EVO_LEVEL, 36, SPECIES_SAMUROTT_HISUI, CONDITIONS({IF_HOLD_ITEM, ITEM_STRANGE_SOUVENIR})}),
    },
    ...
    [SPECIES_PETILIL] =
    {
        ...
        .evolutions = EVOLUTION({EVO_ITEM, ITEM_SUN_STONE, SPECIES_LILLIGANT, CONDITIONS({IF_HOLD_ITEM, ITEM_STRANGE_SOUVENIR})},
    ...
    [SPECIES_BISHARP] =
    {
        ...
        .evolutions = EVOLUTION({EVO_BATTLE_END, 0, SPECIES_KINGAMBIT, CONDITIONS({IF_CRITICAL_HITS_GE, 3})}),
    #endif
    },
    ...
    [SPECIES_RUFFLET] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 54, SPECIES_BRAVIARY, CONDITIONS({IF_HOLD_ITEM, ITEM_STRANGE_SOUVENIR})},
