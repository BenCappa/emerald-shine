...
const struct SpeciesInfo gSpeciesInfoGen8[] =
{
    ...
    [SPECIES_MILCERY] =
    {
        ...
        .evolutions = EVOLUTION({EVO_ITEM_HOLD_DAY, ITEM_STRAWBERRY_SWEET, SPECIES_ALCREMIE_STRAWBERRY_RUBY_CREAM},
                                {EVO_ITEM_HOLD_DAY, ITEM_LOVE_SWEET, SPECIES_ALCREMIE_LOVE_RUBY_SWIRL},
                                {EVO_ITEM_HOLD_DAY, ITEM_BERRY_SWEET, SPECIES_ALCREMIE_BERRY_RUBY_SWIRL},
                                {EVO_ITEM_HOLD_DAY, ITEM_CLOVER_SWEET, SPECIES_ALCREMIE_CLOVER_CARAMEL_SWIRL},
                                {EVO_ITEM_HOLD_DAY, ITEM_FLOWER_SWEET, SPECIES_ALCREMIE_FLOWER_CARAMEL_SWIRL},
                                {EVO_ITEM_HOLD_DAY, ITEM_STAR_SWEET, SPECIES_ALCREMIE_STAR_VANILLA_CREAM},
                                {EVO_ITEM_HOLD_DAY, ITEM_RIBBON_SWEET, SPECIES_ALCREMIE_RIBBON_VANILLA_CREAM},
                                {EVO_ITEM_HOLD_NIGHT, ITEM_STRAWBERRY_SWEET, SPECIES_ALCREMIE_STRAWBERRY_LEMON_CREAM},
                                {EVO_ITEM_HOLD_NIGHT, ITEM_LOVE_SWEET, SPECIES_ALCREMIE_LOVE_RAINBOW_SWIRL},
                                {EVO_ITEM_HOLD_NIGHT, ITEM_BERRY_SWEET, SPECIES_ALCREMIE_BERRY_MINT_CREAM},
                                {EVO_ITEM_HOLD_NIGHT, ITEM_CLOVER_SWEET, SPECIES_ALCREMIE_CLOVER_MATCHA_CREAM},
                                {EVO_ITEM_HOLD_NIGHT, ITEM_FLOWER_SWEET, SPECIES_ALCREMIE_FLOWER_MATCHA_CREAM},
                                {EVO_ITEM_HOLD_NIGHT, ITEM_STAR_SWEET, SPECIES_ALCREMIE_STAR_LEMON_CREAM},
                                {EVO_ITEM_HOLD_NIGHT, ITEM_RIBBON_SWEET, SPECIES_ALCREMIE_RIBBON_SALTED_CREAM}),
    },
