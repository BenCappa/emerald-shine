...
const struct SpeciesInfo gSpeciesInfoGen8[] =
{
    ...
    [SPECIES_DIPPLIN] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 0, SPECIES_HYDRAPPLE, CONDITIONS({IF_SPECIES_IN_PARTY, SPECIES_FLAPPLE})},
                                {EVO_LEVEL, 0, SPECIES_HYDRAPPLE, CONDITIONS({IF_SPECIES_IN_PARTY, SPECIES_APPLETUN})}),
    },
