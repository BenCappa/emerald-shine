...
#define EXEGGUTOR_SP_DEF (P_UPDATED_STATS >= GEN_7 ? 75 : 65)
    ...
    [SPECIES_CUBONE] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 28, SPECIES_MAROWAK},
                                {EVO_LEVEL_STRANGE_SOUVENIR, 28, SPECIES_MAROWAK_ALOLA},
    ...
    [SPECIES_KOFFING] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 35, SPECIES_WEEZING},
                                {EVO_LEVEL_STRANGE_SOUVENIR, 35, SPECIES_WEEZING_GALAR}),
    },
    ...
    [SPECIES_SCYTHER] =
    {
        ...
        .evolutions = EVOLUTION({EVO_ITEM, ITEM_METAL_ALLOY, SPECIES_SCIZOR},
