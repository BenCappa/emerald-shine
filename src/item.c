...
const struct TmHmIndexKey gTMHMItemMoveIds[NUM_ALL_MACHINES + 1] =
{
     ...
     * [2] = { ITEM_TM_LEECH_LIFE, MOVE_DRAGON_CLAW },
     * [3] = { ITEM_TM_PAYBACK, MOVE_WATER_PULSE },
     * etc etc
    */
};
...
void SetBagItemsPointers(void)
{
    ...
    gBagPockets[POCKET_MEDICINE].itemSlots = gSaveBlock2Ptr->medicine;
    ...
    gBagPockets[POCKET_BATTLE_ITEMS].itemSlots = gSaveBlock2Ptr->battleItems;
    gBagPockets[POCKET_BATTLE_ITEMS].capacity = BAG_BATTLEITEMS_COUNT;
    gBagPockets[POCKET_BATTLE_ITEMS].id = POCKET_BATTLE_ITEMS;

    gBagPockets[POCKET_TM_HM].itemSlots = gSaveBlock2Ptr->TMsHMs;
    ...
    gBagPockets[POCKET_TREASURES].itemSlots = gSaveBlock2Ptr->treasures;
    gBagPockets[POCKET_TREASURES].capacity = BAG_TREASURES_COUNT;
    gBagPockets[POCKET_TREASURES].id = POCKET_TREASURES;

    gBagPockets[POCKET_MEGA_STONES].itemSlots = gSaveBlock2Ptr->megaStones;
