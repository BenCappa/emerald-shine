...
static const u16 sVerdanturfTentRewards[] = {ITEM_GALLADITE};
...
static const u16 sFallarborTentRewards[] = {ITEM_WEAKNESS_POLICY};
...
static const u16 sSlateportTentRewards[] = {ITEM_BLUNDER_POLICY};
