...
static const u16 sPrizeListRareCandy1[]      = {ITEM_RARE_CANDY,       ITEM_PP_UP, ITEM_MAX_POTION, ITEM_REVIVE, ITEM_REPEL, ITEM_GREAT_BALL};
static const u16 sPrizeListLuxuryBall1[]     = {ITEM_LUXURY_BALL,      ITEM_PP_UP, ITEM_MAX_POTION, ITEM_REVIVE, ITEM_REPEL, ITEM_GREAT_BALL};
static const u16 sPrizeListMaxRevive1[]      = {ITEM_MAX_REVIVE,       ITEM_PP_UP, ITEM_MAX_POTION, ITEM_REVIVE, ITEM_REPEL, ITEM_GREAT_BALL};
static const u16 sPrizeListMaxEther1[]       = {ITEM_ETHER,            ITEM_PP_UP, ITEM_MAX_POTION, ITEM_REVIVE, ITEM_REPEL, ITEM_GREAT_BALL};
static const u16 sPrizeListElixir1[]         = {ITEM_ELIXIR,           ITEM_PP_UP, ITEM_MAX_POTION, ITEM_REVIVE, ITEM_REPEL, ITEM_GREAT_BALL};
static const u16 sPrizeListSnowball[]        = {ITEM_SNOWBALL,         ITEM_PP_UP, ITEM_MAX_POTION, ITEM_REVIVE, ITEM_REPEL, ITEM_GREAT_BALL};
static const u16 sPrizeListLure[]            = {ITEM_LURE,             ITEM_PP_UP, ITEM_MAX_POTION, ITEM_REVIVE, ITEM_REPEL, ITEM_GREAT_BALL};
static const u16 sPrizeListAuspiciousArmor[] = {ITEM_AUSPICIOUS_ARMOR, ITEM_PP_UP, ITEM_MAX_POTION, ITEM_REVIVE, ITEM_REPEL, ITEM_GREAT_BALL};
...
static const u16 *const sPrizeLists1[NUM_TRAINER_HILL_PRIZE_LISTS] =
{
    ...
    sPrizeListSnowball,
    sPrizeListLure,
    sPrizeListAuspiciousArmor,
    sPrizeListMaliciousArmor,
    sPrizeListBeastBall
};
...
static const u16 *const sPrizeLists2[NUM_TRAINER_HILL_PRIZE_LISTS] =
{
    ...
    sPrizeListMaxEther2,
    sPrizeListElixir2,
    sPrizeListMaxMushrooms,
    sPrizeListAbilityPatch,
    sPrizeListSkullFossil,
    sPrizeListSailFossil,
...
static u16 GetPrizeItemId(void)
{
    ...
    // entering the Hall of Fame, there would be 1 additional prize possibility (ITEM_ETHER)
