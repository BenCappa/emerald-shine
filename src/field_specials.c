...
static const u8 *const sScrollableMultichoiceOptions[][MAX_SCROLL_MULTI_LENGTH] =
{
    ...
    [SCROLL_MULTI_BF_MOVE_TUTOR_1] =
    {
        ...
        COMPOUND_STRING("Terrain Pulse{CLEAR_TO 0x4E}24BP"),
        COMPOUND_STRING("Fire Fang{CLEAR_TO 0x4E}36BP"),
        COMPOUND_STRING("Thunder Fang{CLEAR_TO 0x4E}36BP"),
        COMPOUND_STRING("Ice Fang{CLEAR_TO 0x4E}36BP"),
        COMPOUND_STRING("Grassy Glide{CLEAR_TO 0x4E}36BP"),
        COMPOUND_STRING("Liquidation{CLEAR_TO 0x4E}48BP"),
        COMPOUND_STRING("Poltergeist{CLEAR_TO 0x4E}48BP"),
        COMPOUND_STRING("Scale Shot{CLEAR_TO 0x4E}48BP"),
        gText_Exit
    },
    [SCROLL_MULTI_BF_MOVE_TUTOR_2] =
    {
        COMPOUND_STRING("Roost{CLEAR_TO 0x4E}16BP"),
        COMPOUND_STRING("Corrosive Gas{CLEAR_TO 0x4E}16BP"),
        COMPOUND_STRING("Seismic Toss{CLEAR_TO 0x4E}24BP"),
        COMPOUND_STRING("Rock Slide{CLEAR_TO 0x4E}36BP"),
        COMPOUND_STRING("Skitter Smack{CLEAR_TO 0x4E}36BP"),
        COMPOUND_STRING("Dream Eater{CLEAR_TO 0x4E}36BP"),
        COMPOUND_STRING("Steel Roller{CLEAR_TO 0x4E}36BP"),
        COMPOUND_STRING("{FONT_NARROW}Stomping Tantrum{CLEAR_TO 0x4E}{FONT_NORMAL}48BP"),
        COMPOUND_STRING("Lash Out{CLEAR_TO 0x4E}48BP"),
        COMPOUND_STRING("{FONT_NARROW}Misty Explosion{CLEAR_TO 0x4E}{FONT_NORMAL}48BP"),
        gText_Exit
    },
