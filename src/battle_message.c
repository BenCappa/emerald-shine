...
const u8 *const gBattleStringsTable[BATTLESTRINGS_COUNT] =
{
    ...
    [STRINGID_STOPLEARNINGMOVE]                     = COMPOUND_STRING("{PAUSE 32}Do you want to continue having {B_BUFF1} learn {B_BUFF2}?"),
    ...
    [STRINGID_PKMNDROPPEDITEM]                      = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX} dropped its {B_LAST_ITEM}!{WAIT_SE}"),
    [STRINGID_BAGISFULL]                            = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX} dropped {B_LAST_ITEM}!{WAIT_SE}\pBut your bag is full!"),
};
