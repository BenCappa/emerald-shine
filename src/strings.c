...
const u8 gText_ExpandedPlaceholder_May[] = _("Ashley");
...
const u8 gText_DefaultName[] = _("Ashley");
...
const u8 gText_HOFDexRating[] = _("Spotted Pokémon: {STR_VAR_1}!\nOwned Pokémon: {STR_VAR_2}!\pGump's Pokédex rating!\pGump: Let's see…\p");
...
const u8 gText_BirchInTrouble[] = _("The old man is in trouble!\nRelease a Pokémon and rescue him!");
...
const u8 gText_DadsAdvice[] = _("Ben's advice…\n{PLAYER}, there's a time and place for\leverything!{PAUSE_UNTIL_PRESS}");
...
const u8 *const gPocketNamesStringsTable[] =
{
    ...
    [POCKET_BATTLE_ITEMS] = COMPOUND_STRING("{FONT_NARROW}BATTLE ITEMS"),
...
const u8 gText_Niles[] = _("NILES");
const u8 gText_Winona[] = _("WINONA");
const u8 gText_Juan[] = _("JUAN");
