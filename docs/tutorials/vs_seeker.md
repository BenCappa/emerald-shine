...
### New Trainers
#### Party / `gRematchTable`
Each of the rematches for the Trainer must be defined as seperate Trainers in `src/data/trainers.party` and `include/constants/opponents`. For example, `TRAINER_JOEY_1` also has `TRAINER_JOEY_2`,`TRAINER_JOEY_3`,`TRAINER_JOEY_4`, and `TRAINER_JOEY_5`.  
...
Route102_EventScript_Calvin::
    vsseeker_rematchid TRAINER_JOEY_1
    applymovement LOCALID_CALVIN, CalvinMovementTest
    waitmovement 0
    trainerbattle_single TRAINER_JOEY_1, Route102_Text_CalvinIntro, Route102_Text_CalvinDefeated, Route102_EventScript_CalvinRegisterMatchCallAfterBattle
    specialvar VAR_RESULT, ShouldTryRematchBattle
    goto_if_eq VAR_RESULT, TRUE, Route102_EventScript_CalvinRematch
    setvar VAR_0x8004, TRAINER_JOEY_1
